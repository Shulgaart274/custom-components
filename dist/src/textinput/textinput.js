...
var _textinputModule = _interopRequireDefault(require("./textinput.module.scss"));
...
var TextInput = function TextInput(_ref) {
  var _ref$variant = _ref.variant,
      ...
      requiredHelper = _ref$requiredHelper === void 0 ? "Textfield can't be empty!" : _ref$requiredHelper,
  ...
  var variantLabelHidden = function variantLabelHidden() {
    switch (variant) {
      case "first":
        return "".concat(_textinputModule.default.labelHidden);

      case "second":
        return "".concat(_textinputModule.default.labelHiddenSecond);
  ...
  var variantInput = function variantInput() {
    switch (variant) {
      case "first":
        return "".concat(_textinputModule.default.customField);

      case "second":
        return "".concat(_textinputModule.default.customField, " ").concat(_textinputModule.default.second);

      case "third":
        return "".concat(_textinputModule.default.customField, " ").concat(_textinputModule.default.third);

      case "fourth":
        return "".concat(_textinputModule.default.customField, " ").concat(_textinputModule.default.fourth);
  ...
  var themeColor = function themeColor() {
    switch (color) {
      case "primary":
        return "".concat(_textinputModule.default.primary);

      case "secondary":
        return "".concat(_textinputModule.default.secondary);

      case "dark":
        return "".concat(_textinputModule.default.dark);
  ...
  var isLabelShown = value.length > 0 ? variantLabelHidden() : "".concat(_textinputModule.default.label);
  return /*#__PURE__*/_react.default.createElement("label", {
    ...
    className: "".concat(_textinputModule.default.textInput, " ").concat(themeColor()),
    variant: variant,
    maxLength: maxLength,
    type: "text",
    id: id,
  ...
  }, required ? "".concat(label, "*") : label), /*#__PURE__*/_react.default.createElement("span", {
    className: "".concat(_textinputModule.default.border, " ").concat(themeColor())
  }));
};
